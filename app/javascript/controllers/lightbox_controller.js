...
export default class extends Controller {
  ...
  #render() {
    ...
    const closeBtn = this.#createButton(
      'close',
      '&times;',
      'Close image viewer (Escape)',
      'absolute top-4 right-4 text-white text-4xl w-12 h-12 flex items-center justify-center rounded hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white z-50',
    )
    ...
    const prevBtn = this.#createButton(
      ...
      `absolute left-4 text-white text-5xl w-12 h-full flex items-center justify-center rounded hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white${isFirst ? ' opacity-30 cursor-not-allowed' : ''}`,
    )
    ...
    const nextBtn = this.#createButton(
      ...
      `absolute right-4 text-white text-5xl w-12 h-full flex items-center justify-center rounded hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white${isLast ? ' opacity-30 cursor-not-allowed' : ''}`,
    )
